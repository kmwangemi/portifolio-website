export const projects = [
  {
    ...
    tags: ['React/Angular', 'Node', 'Express', 'Mongo'],
  ...
  },
  {
    id: 2,
    title: 'CMO App',
    description: "An online platform for artists to store, report, and manage their musical works.",
    image: '/images/cmoinabox.png',
    tags: ['React/Typescript', 'Node', 'Express', 'Mongo'],
    visit: 'https://www.cmoinabox.org/'
  },
  {
    id: 3,
    title: 'Broadcaster Music Licencing App',
    description: "An internet-based platform designed to oversee the licensing of music for broadcasters.",
    image: '/images/broadcasterlicence.png',
    tags: ['React/Typescript', 'Node', 'Express', 'Mongo'],
    visit: 'https://broadcaster-licencing-app-user-frontend.vercel.app/'
  },
];
